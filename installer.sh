...
wget --no-check-certificate --no-cache --no-dns-cache 'https://github.com/Belfagor2005/Filmon/archive/refs/heads/main.tar.gz'
tar -xzf main.tar.gz
...
echo ""
echo "#########################################################"
echo "#          Filmon Live INSTALLED SUCCESSFULLY           #"
